...
public class FormSistema extends javax.swing.JFrame {
    Pilha <Recorde> pilhaPrincipal = new Pilha(10);
    Pilha <Recorde> pilhaAuxiliar = new Pilha(10);
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pilhajava/corrida.png"))); // NOI18N
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
       Recorde novoRecorde = new Recorde();
        ...
        novoRecorde.setData(data);
        novoRecorde.setTempo(Double.parseDouble(txtTempo.getText()));
        
        if(pilhaPrincipal.isEmpty() || pilhaPrincipal.peek().getTempo() > novoRecorde.getTempo()){
